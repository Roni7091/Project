		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "northwind1",
									"targetURL": "#comexamplenorthwind1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplenorthwind1-display": {
								"semanticObject": "comexamplenorthwind1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.northwind1",
									"url": sap.ui.require.toUrl("com/example/northwind1")
								}
							}
						}
					}
